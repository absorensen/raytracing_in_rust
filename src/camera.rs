...
impl Camera {
    pub fn new(look_from: Point3, look_at: Point3, v_up: Vector3, vfov: f64, aspect_ratio: f64, aperture: f64, focus_dist: f64) -> Self {
    ...
    pub fn get_ray(&self, s: f64, t: f64) -> Ray {
        ...
        Ray{origin: self.origin + offset, direction: self.lower_left_corner + s*self.horizontal + t*self.vertical - self.origin - offset}
    }
}